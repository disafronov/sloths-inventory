## [3.3.3](https://github.com/disafronov/sloths-inventory/compare/v3.3.2...v3.3.3) (2026-09-19)

## [3.3.3-rc.2](https://github.com/disafronov/sloths-inventory/compare/v3.3.3-rc.1...v3.3.3-rc.2) (2026-09-19)

## [3.3.3-rc.1](https://github.com/disafronov/sloths-inventory/compare/v3.3.2...v3.3.3-rc.1) (2026-08-20)
...
* default SECURE_SSL_REDIRECT, SESSION_COOKIE_SECURE, CSRF_COOKIE_SECURE to not DEBUG ([434efe7](https://github.com/disafronov/sloths-inventory/commit/434efe79dbf4b1e4cf26028056f096b54284c3ee))

## [3.3.1](https://github.com/disafronov/sloths-inventory/compare/v3.3.0...v3.3.1) (2026-06-08)

### Bug Fixes

* expired PendingTransfer no longer blocks new transfers in clean() ([2fa0457](https://github.com/disafronov/sloths-inventory/commit/2fa04570d37e97ad19a7ecd32b73ab4120c3f9f0))
* honestly say email is queued when async backend is used ([d9aa64b](https://github.com/disafronov/sloths-inventory/commit/d9aa64bbbd01acdc34375daee95ee2b08216a73f))
...
* bump ([c099d6e](https://github.com/disafronov/sloths-inventory/commit/c099d6ed7d0a0aeca65f81d5f66aa9b7af8f0594))

### Bug Fixes

* pip audit ([82b6096](https://github.com/disafronov/sloths-inventory/commit/82b609690907677eff4309abcc8d97b13d8f108e))

## [3.2.0](https://github.com/disafronov/sloths-inventory/compare/v3.1.0...v3.2.0) (2026-06-02)

### Features

* **common:** add supervised process launcher commands ([ef25272](https://github.com/disafronov/sloths-inventory/commit/ef252729355fee1764aa7449f5b3f1018a9d3ec5))
* switch async email from daemon threads to django-q2 ([836bdf5](https://github.com/disafronov/sloths-inventory/commit/836bdf5e5b052c5104fe65bc466e48c8d0ffcd38))

### Bug Fixes

* paths handling ([b758a29](https://github.com/disafronov/sloths-inventory/commit/b758a29693bf68beaedb75fd15d77cefb9e1c880))

## [3.2.0-rc.2](https://github.com/disafronov/sloths-inventory/compare/v3.2.0-rc.1...v3.2.0-rc.2) (2026-06-02)
...
* **inventory:** protect PendingTransfer from silent item deletion on CASCADE→PROTECT ([8092667](https://github.com/disafronov/sloths-inventory/commit/8092667d976a49c03998a7bb703e4d24faaeb45a))
...
* Update translations and templates ([b76d92d](https://github.com/disafronov/sloths-inventory/commit/b76d92d74ebccf297ceceef8a8b6737e63c28625))

## [1.10.1-rc.1](https://github.com/disafronov/sloths-inventory/compare/v1.10.0...v1.10.1-rc.1) (2026-05-07)
...
* Add email validation to Responsible model ([cc7dd0f](https://github.com/disafronov/sloths-inventory/commit/cc7dd0fbb2d583799273222893e45fa943983ac5))
* add missing email warning banner ([a7d53b5](https://github.com/disafronov/sloths-inventory/commit/a7d53b5534e5d5cb43c861fa78f44b961f52b73d))

### Bug Fixes

* add error handling to signals and tests ([2f934df](https://github.com/disafronov/sloths-inventory/commit/2f934df1572f829f636ea7a16daea7477df07d0a))

## [1.9.0](https://github.com/disafronov/sloths-inventory/compare/v1.8.0...v1.9.0) (2026-05-07)

### Features

* Add responsible signals and email notifications ([5730a12](https://github.com/disafronov/sloths-inventory/commit/5730a1262924c25e9bdf219f39b281aa3a46e28f))
* **email:** Add operation assignment/unassignment/updated email templates ([cf61e73](https://github.com/disafronov/sloths-inventory/commit/cf61e7330a35f969629884de265bb73ae9cc0130))

### Bug Fixes

* change transfer status to "being transferred" ([bd510fc](https://github.com/disafronov/sloths-inventory/commit/bd510fce300003303cb5a6074829c5c4b2007ccf))
* Improve signal notification handling for inventory operations ([339ffad](https://github.com/disafronov/sloths-inventory/commit/339ffad139de7333743cc7903c6243e1c3d4f4a3))
* move accepted_at update to before Operation creation in PendingTransfer BaseModel to maintain data consistency ([a8e134f](https://github.com/disafronov/sloths-inventory/commit/a8e134f329440593df44dc8e5d5937e6561375f2))
* send email when responsible user's profile is updated even if user remains the same ([686af91](https://github.com/disafronov/sloths-inventory/commit/686af9122b527acd41fea00168c1dd8ce573b2d1))
...
* add email functionality for transfer acceptance, including retry mechanism and templating ([d53d606](https://github.com/disafronov/sloths-inventory/commit/d53d60601fef7dbe672d8fdb764d9e236743e96f))
...
## [1.7.0](https://github.com/disafronov/sloths-inventory/compare/v1.6.0...v1.7.0) (2026-05-03)

### Features

* add password reset functionality with email support ([b8b815c](https://github.com/disafronov/sloths-inventory/commit/b8b815ccbad52fab5184d869f1350cb6bf65272b))
* **auth:** add email change functionality with confirmation flow ([04e29c6](https://github.com/disafronov/sloths-inventory/commit/04e29c629dbf70c594c47e3e6909ee2fa61ca00f))
...
* **inventory:** apply search query to pending transfers ([ad0ed29](https://github.com/disafronov/sloths-inventory/commit/ad0ed29c8830ea9e72bd3c00feb6b12537b7c648))
* **inventory:** disable search form for users with no responsible person attached ([bbb9b0e](https://github.com/disafronov/sloths-inventory/commit/bbb9b0ee0f79fdfc6ffd3e18b66ea978f74f28c1))
* **inventory:** update item and previous item messages for clarity ([84635ca](https://github.com/disafronov/sloths-inventory/commit/84635caa59fc2fcde9d442deef2529b55a125505))

### Bug Fixes

* **inventory:** update conditional rendering for search forms in item templates ([ae29803](https://github.com/disafronov/sloths-inventory/commit/ae29803b86280d557f397f6220657dfa40e71ff1))

## [1.5.0](https://github.com/disafronov/sloths-inventory/compare/v1.4.0...v1.5.0) (2026-05-02)

### Features

* **catalogs:** add Responsible helpers for inventory UI and transfers ([da346ee](https://github.com/disafronov/sloths-inventory/commit/da346ee73ef5da7d9a7353d063799e4db803aca5))
* **inventory:** add management command to profile list query plans ([c3bea0a](https://github.com/disafronov/sloths-inventory/commit/c3bea0a18ce7e016cb93995ad8a1a88c56967215))
* **inventory:** add presentation helper for ValidationError strings ([bcd3736](https://github.com/disafronov/sloths-inventory/commit/bcd3736092122982a6e6f0f5cea0ed422537a7b0))
* **inventory:** add query managers and page data builders on models ([1bbca0a](https://github.com/disafronov/sloths-inventory/commit/1bbca0aa101ceee01509bc68a9d63f78762331c1))
* **inventory:** enforce accountability for location changes in Item model ([9635f09](https://github.com/disafronov/sloths-inventory/commit/9635f0971089d840a92a63e32f354f97936834e5))
* **inventory:** expose accept journal head id in item history context ([6f926d5](https://github.com/disafronov/sloths-inventory/commit/6f926d540ce74ee05a7681243333e71665496593))
* **inventory:** implement ChangeLocationForm for location change validation ([4aa9e59](https://github.com/disafronov/sloths-inventory/commit/4aa9e594e8802044f372922e7f499098593d010e))
* **inventory:** implement flash messages for transfer actions ([dea6de1](https://github.com/disafronov/sloths-inventory/commit/dea6de1fb880926b90022b555ea6d6bb573e5623))
* **inventory:** include journal head in Accept form on item history ([df5fa94](https://github.com/disafronov/sloths-inventory/commit/df5fa94509aa5f1fc354491d24abe16173e9d304))
* **inventory:** validate accept against latest operation; refine inactive redirects ([7500996](https://github.com/disafronov/sloths-inventory/commit/75009966be716195d9897293d25e574cb505d2b8))

### Bug Fixes

* **devices:** coerce is_catalog_reference_in_use to bool for mypy ([dd013c5](https://github.com/disafronov/sloths-inventory/commit/dd013c572388ba7ca6d12628c74bfbb609a4a896))
* **inventory:** enforce sender validation in PendingTransfer acceptance ([1e6d056](https://github.com/disafronov/sloths-inventory/commit/1e6d05657c971f29b2eac6ef4a02e4f14e53eb67))
* **inventory:** update translation files and add new messages ([9651ec1](https://github.com/disafronov/sloths-inventory/commit/9651ec17560c8a1c82c29bfafc0a405f8c53bebf))

### Performance Improvements

* **inventory:** add Operation composite index for list queries ([c8ef1fe](https://github.com/disafronov/sloths-inventory/commit/c8ef1fed7c36a119caba23aa9fe0d8e781663b12))
